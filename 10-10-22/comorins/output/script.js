  ...
  {    
    ...
    brand:"Addi,Nike,Adidas",
     productMenu:[  
        {
            id:1,
            img:"https://rukminim1.flixcart.com/image/495/594/ktizdzk0/shoe/y/b/x/7-ws-9310-tying-grey-original-imag6ut3hzm2zyqm.jpeg?q=50",
           p_name:"Thar-01 Blue Sneakers,Sports,Training,Gym,Walking,Stylish For Men  (Blue, Orange)",
            price:"₹500",
            size:"Size : 6,7,8,9",
            Delivery:"free delivery"
        },
        {
           ...
           p_name:"Express-08 Grey Sports,Walking,Running,Gym Running Shoes For Men  (Grey, Green)",
            price:"₹450",
            size:"Size : 6,7,8,9",
            Delivery:"free delivery"
        },
        {
           ...
           p_name:"SOCKS Training & Gym Shoes For Men  (Blue)",
            price:"₹1500",
            size:"Size : 6,7,8,9",
            Delivery:"free delivery"
        },
        {
         ...
         p_name:"Men 9325 Latest Collection Stylish Sports Sneakers Running Shoes Running Shoes For Men  (Red, Black)",
          price:"₹500",
          size:"Size : 6,7,8,9",
          Delivery:"free delivery"
      },
    ...
    brand:"TIMEMORE ,Titen,Sonata",
     productMenu:[  
        ...
        },
        {
           ...
           p_name:"LED-SQ YOUTH CLUB- LED-SQ DIGITAL WATCH FOR GIRLS & BOYS Digital Watch",
            price:"₹1500",
            size:"6,7,8,9",
            Delivery:"free delivery"
        },
  ...
  {    
    ...
    brand:"livepet,sony",
     productMenu:[  
        {
            id:1,
            img:"https://rukminim1.flixcart.com/image/312/312/ktbu6q80/mobile/x/w/y/8i-rmx3151-realme-original-imag6zhnabagtrzu.jpeg?q=70",
    ...
    brand:"livepet,sony",
     productMenu:[  
        ...
        },
        {
           ...
           p_name:"Divine Arts Sheesham Wood Set with 6 Chairs for Dining Room Solid Wood 6 Seater Dining Table ",
            price:"₹450",
            size:"6,7,8,9",
            Delivery:"free delivery"
        },
        {
           ...
           p_name:"Godrej Interio Toast Engineered Wood 6 Seater Dining Table  (Finish Color - Walnut, Knock Down)",
            price:"₹1500",
            size:"6,7,8,9",
            Delivery:"free delivery"
        },
...
if(! localStorage.getItem("flipart")){
  localStorage.setItem("flipkart",JSON.stringify(products))
  }

  

function returnCards(products) {
    return "<div class=\"products-cards\">" +products.map(title=> `
    <div class=\"card-item\ text-center col-3">
   
      <div class="product-header">
      <a href="view.html?product_name=${title.product_name}"><img src="${title.img}"/></a>
      </div>
      <div class="product-content">
        <h4>${title.product_name}</h4>
        <p>${title.brand}</p>
      </div> 
   ...
   product_section.innerHTML = returnCards(products);

  // function search(){
  //   let allItem=document.getElementById("tofind").value;
  //   let pro=localStorage.getItem("flipkart");
  //   console.log(pro);
